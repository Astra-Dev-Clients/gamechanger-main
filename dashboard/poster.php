...
$org_website = "https://gcstudyabroad.co.ke";
...
.logo p { font-weight: 600; font-size: 1.5em; color: #fff; }
...
.top-actions button:first-child { background: #ffc107; }
.top-actions button:last-child { background: #0d6efd; }

/* Optional – disable media resizing entirely */
